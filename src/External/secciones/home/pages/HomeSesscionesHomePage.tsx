...
export const HomeSesscionesHomePage = () => {
  return (
    <main>
      ...
      <meta name="description" content="Bienvenido a la página principal de Herz Edel." />
      <meta property="og:title" content="Inicio | Herz Edel" />
      <meta property="og:description" content="Bienvenido a la página principal de Herz Edel." />
